...
import { buildCsv, rangeFor, sendReport } from "@/lib/reports";

export const dynamic = "force-dynamic";

// GET ?range=week|month&offset=0|-1  -> CSV download
export async function GET(request: Request) {
  ...
  return new NextResponse(csv, {
    headers: {
      ...
      "Content-Disposition": `attachment; filename="attendance-${range.label}.csv"`,
    },
  });
}
